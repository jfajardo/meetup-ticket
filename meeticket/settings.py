"""
Django settings for meeticket project.
...
SECRET_KEY = '=b&yv3e5@!!8jdq5n$+41q^$z^=meynv=i8ypg1sovq0ll_z^v'
...
WSGI_APPLICATION = 'meeticket.wsgi.application'
